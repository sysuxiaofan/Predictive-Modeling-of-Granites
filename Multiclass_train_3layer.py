...
from sklearn.model_selection import GridSearchCV
from keras.wrappers.scikit_learn import KerasClassifier
def build_model(n_neurons1=30,n_neurons2=30, n_neurons3=10,input_shape=[44]):
...
# c.to_csv('C:/Users/WKQ/Desktop/tangao代码/结果3层/acc.csv')
#Feature importance ranking
model = build_model(n_neurons1=80,n_neurons2=50,n_neurons3=90,input_shape=[44])
...
#
    ...
    model2=build_model(n_neurons1=50,n_neurons2=50,n_neurons3=20,input_shape=[43])
    Hit1=model2.fit(x,Y_train2,validation_data=(x2,Y_vaild),epochs=5,verbose=0)
